...
public class Delivery {
    ...
    public static Delivery draft() {
        ...
        delivery.setStatus(DeliveyStatus.DRAFT);
    ...
    public void palce() {
        verifyIfCanBePlaced();
        this.setStatus(DeliveyStatus.WAITING_FOR_COURIER);
        this.setPlacedAt(OffsetDateTime.now());
    }

    public  void pickUp(UUID courierId) {
        this.setCourierId(courierId);
        this.setStatus(DeliveyStatus.IN_TRANSIT);
        this.setAssignedAt(OffsetDateTime.now());
    }

    public void markAsDelivered() {
        this.setStatus(DeliveyStatus.DELIVERED);
    ...
    private void verifyIfCanBePlaced() {
        ...
        if (getStatus().equals(DeliveyStatus.DRAFT)) {
            throw new DomainException();
        }
    }
